...
4. Reserva archivos exactos en tu propio
   `.coordination/claims/<thread-id>.md`.
...
- Actualiza tu claim tras cada hito y antes de terminar.
- Registra resultado, verificaciones, decisiones y pendientes en un handoff.
